                        ...
                        <table class="table text-nowrap mb-0 align-middle table-hover">
                            <thead class="text-dark fs-4">
                                <tr>
                                    ...
                                    <th>
                                        <h6 class="fw-semibold mb-0">Supir</h6>
                                    </th>
                                    <th>
                                ...
                                @foreach ($data as $key => $value)
                                    @if ($value->status_bayar == 'pending')
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <h6 class="fw-normal mb-1">{{ $value->supir }}</h6>
                                            </td>
                                            <td class="border-bottom-0">
                                            ...
                                            <td class="border-bottom-0">
                                                @if ($value->status_bayar == 'paid')
                                                    <h6 class="fw-normal badge bg-success">
                                                        {{ $value->status_bayar }}
                                                    </h6>
                                                @else
                                                    <h6 class="fw-normal badge bg-danger">
                                                        {{ $value->status_bayar }}
                                                    </h6>
                                                @endif
                                            </td>
                                            <td class="border-bottom-0">
                                                <div class="d-flex justif-content-center gap-2">
                                                    <a href="{{ route('member-pesanan-detail', $value->id) }}"
